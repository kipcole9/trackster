class Account < ActiveRecord::Base
  ...
  validates_format_of       :email_from,      :with => Authentication.email_regex, :allow_blank => true
  validates_format_of       :email_reply_to,  :with => Authentication.email_regex, :allow_blank => true
