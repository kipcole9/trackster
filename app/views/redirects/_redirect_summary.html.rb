h4 link_to(redirect.name, property_redirect_path(@property, redirect))
...
with_tag(:div, :class => :buttons, :style => "display:none") do
  store link_to(image_tag('/images/icons/delete.png', :class => :deleteListItem), property_redirect_path(@property, redirect), 
